...
export const searchIndex = [
  ...
  },
  {
    ...
    title: 'My Coverage',
    description: 'View your health plan coverage details, benefits, and ID cards.',
    route: ROUTES.COVERAGE,
    category: 'page',
    keywords: ['coverage', 'benefits', 'plan', 'insurance', 'id card', 'deductible', 'copay', 'coinsurance', 'out of pocket', 'oop', 'network'],
    documentId: null,
    icon: 'shield',
  },
  {
